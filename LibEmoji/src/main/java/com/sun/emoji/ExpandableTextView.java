...
public class ExpandableTextView extends AppCompatTextView {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            mEmojiconAlignment = a.getInt(R.styleable.Emojicon_emojiconAlignment1, DynamicDrawableSpan.ALIGN_BASELINE);
     ...
     * 是否支持展开收起，默认支持
     *
     * @param toggleEnable toggleEnable
     */
    ...
    public void setText(CharSequence text, BufferType type) {
        if (!TextUtils.isEmpty(text)) {
            ...
            EmojiIconHandler.addEmojis(getContext(), builder, mEmojiconSize, mEmojiconAlignment, mEmojiconTextSize, mTextStart, mTextLength, mUseSystemDefault);
            text = builder;
        }
    ...
    private class ExpandableClickListener implements OnClickListener {
        ...
        public void onClick(View view) {
            if (!mToggleEnable) {
                if (mOnClickIntoDetailListener != null) {
                    mOnClickIntoDetailListener.click();
                }
                return;
            }
            toggle();
    ...
    public class LinkTouchMovementMethod extends LinkMovementMethod {
        ...
        public boolean onTouchEvent(TextView textView, Spannable spannable, MotionEvent event) {
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                mPressedSpan = null;
                Selection.removeSelection(spannable);
                if (event.getAction() == MotionEvent.ACTION_UP && System.currentTimeMillis() - startTime < 1000) {
                    if (mOnClickIntoDetailListener != null) {
                        mOnClickIntoDetailListener.click();
                    }
                }
    ...
    private OnClickIntoDetailListener mOnClickIntoDetailListener;

    public void setOnClickIntoDetailListener(OnClickIntoDetailListener onClickIntoDetailListener) {
        this.mOnClickIntoDetailListener = onClickIntoDetailListener;
    }

    public interface OnClickIntoDetailListener {
        void click();
    }
}
