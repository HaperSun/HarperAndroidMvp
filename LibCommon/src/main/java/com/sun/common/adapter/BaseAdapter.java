package com.sun.common.adapter;
...
import com.sun.common.adapter.animation.AlphaInAnimation;
import com.sun.common.adapter.animation.BaseAnimation;
import com.sun.common.adapter.animation.ScaleInAnimation;
import com.sun.common.adapter.animation.SlideInBottomAnimation;
import com.sun.common.adapter.animation.SlideInLeftAnimation;
import com.sun.common.adapter.animation.SlideInRightAnimation;
import com.sun.common.adapter.entity.IExpandable;
import com.sun.common.adapter.loadmore.LoadMoreView;
import com.sun.common.adapter.loadmore.SimpleLoadMoreView;
import com.sun.common.adapter.util.MultiTypeDelegate;
 ...
 * @author Harper
 * @date 2022/6/29
 * note:'com.github.CymChad:BaseRecyclerViewAdapterHelper:2.9.30'
 */
    ...
    private void bindViewClickListener(final BaseViewHolder baseViewHolder) {
        ...
        if (getOnItemClickListener() != null) {
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getOnItemClickListener().onItemClick(BaseAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
        if (getOnItemLongClickListener() != null) {
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return getOnItemLongClickListener().onItemLongClick(BaseAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
    }
