...
import static com.sun.common.adapter.BaseAdapter.EMPTY_VIEW;
import static com.sun.common.adapter.BaseAdapter.FOOTER_VIEW;
import static com.sun.common.adapter.BaseAdapter.HEADER_VIEW;
import static com.sun.common.adapter.BaseAdapter.LOADING_VIEW;
...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public static String TAG = SimpleClickListener.class.getSimpleName();
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        if (recyclerView == null) {
            ...
            this.baseAdapter = (BaseAdapter) recyclerView.getAdapter();
