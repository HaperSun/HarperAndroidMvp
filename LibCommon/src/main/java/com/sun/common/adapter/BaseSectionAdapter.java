...
import com.sun.common.adapter.entity.SectionEntity;
 ...
 * note:
 */
public abstract class BaseSectionAdapter<T extends SectionEntity, K extends BaseViewHolder> extends BaseAdapter<T, K> {
