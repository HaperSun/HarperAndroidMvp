...
import com.sun.common.adapter.listener.OnItemDragListener;
import com.sun.common.adapter.listener.OnItemSwipeListener;
 ...
 * note:
 */
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseAdapter<T, K> {
    ...
    public void onBindViewHolder(K holder, int position) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != LOADING_VIEW && viewType != HEADER_VIEW
            ...
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                ...
                if (toggleView != null) {
                    toggleView.setTag(R.id.BaseAdapter_view_holder_support, holder);
                    if (mDragOnLongPress) {
                ...
                holder.itemView.setTag(R.id.BaseAdapter_view_holder_support, holder);
            ...
            mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mItemTouchHelper != null && itemDragEnabled) {
                        mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(R.id.BaseAdapter_view_holder_support));
                    }
                    return true;
                }
            };
     ...
     * You should attach {@link ItemTouchHelper} which construct with ItemDragAndSwipeCallback to the Recycler when you enable this.
     */
