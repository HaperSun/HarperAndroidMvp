...
public class RoundLayout extends RelativeLayout {
    ...
    public RoundLayout(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            float radius = typedArray.getDimension(R.styleable.RoundLayout_radius, 0);
            topLeftRadius = typedArray.getDimension(R.styleable.RoundLayout_topLeftRadius, radius);
            topRightRadius = typedArray.getDimension(R.styleable.RoundLayout_topRightRadius, radius);
            bottomLeftRadius = typedArray.getDimension(R.styleable.RoundLayout_bottomLeftRadius, radius);
            bottomRightRadius = typedArray.getDimension(R.styleable.RoundLayout_bottomRightRadius, radius);
            typedArray.recycle();
        }
