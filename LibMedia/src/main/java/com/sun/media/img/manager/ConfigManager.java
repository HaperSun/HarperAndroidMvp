...
public class ConfigManager {
    ...
    public IImgLoader getImageLoader() throws Exception {
        if (IImgLoader == null) {
    ...
    public void setImageLoader(IImgLoader IImgLoader) {
        this.IImgLoader = IImgLoader;
    }
}
