...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    public void setSwitchView(ImageView mSwitchView, ImageView mFlashLamp) {
        ...
        if (mSwitchView != null) {
            cameraAngle = CameraParamUtil.getInstance().getCameraDisplayOrientation(mSwitchView.getContext(), selectedCamera);
        }
    }
    ...
    private void rotationAnimation() {
        ...
        if (rotation != angle) {
            ...
            ObjectAnimator animC = ObjectAnimator.ofFloat(mSwitchView, "rotation", startRotation, endRotation);
            ObjectAnimator animF = ObjectAnimator.ofFloat(mFlashLamp, "rotation", startRotation, endRotation);
    ...
    public void setZoom(float zoom, int type) {
        ...
        switch (type) {
            ...
            case TYPE_CAPTURE:
                ...
                LogHelper.i("setZoom = " + nowScaleRate);
                break;
        }
...
//        mCamera = Camera.open();
    ...
    public void doStartPreview(SurfaceHolder holder, float screenProp) {
        if (isPreviewing) {
            LogHelper.i("doStartPreview isPreviewing");
        }
