...
public class TCNetWatcher {

    final static int                        WATCH_TIME = 30000;         // 监控总时长ms
    final static int                        MAX_LOADING_COUNT = 3;      // 弹出切换清晰度提示框的loading总次数
    final static int                        MAX_LOADING_TIME = 10000;   // 一次loading的判定时长ms
    ...
    public TCNetWatcher(Context context) {
