...
import com.sun.media.video.thread.UiThreadExecutor;
import com.sun.media.video.ui.adapter.VideoTrimmerAdapter;
import com.sun.media.video.util.StorageUtil;
import com.sun.media.video.util.VideoTrimmerUtil;

import static com.sun.media.video.util.VideoTrimmerUtil.MAX_COUNT_RANGE;
import static com.sun.media.video.util.VideoTrimmerUtil.MAX_SHOOT_DURATION;
import static com.sun.media.video.util.VideoTrimmerUtil.RECYCLER_VIEW_PADDING;
import static com.sun.media.video.util.VideoTrimmerUtil.THUMB_WIDTH;
import static com.sun.media.video.util.VideoTrimmerUtil.VIDEO_FRAMES_WIDTH;
...
public class VideoTrimmerView extends FrameLayout implements IVideoTrimmerView {
    ...
    private void startShootVideoThumbs(final Context context, final Uri videoUri, int totalThumbsCount, long startPosition, long endPosition) {
        VideoTrimmerUtil.shootVideoThumbInBackground(context, videoUri, totalThumbsCount, startPosition, endPosition, new SingleCallback<Bitmap, Integer>() {
            @Override
    ...
    private void updateVideoProgress() {
        ...
        Log.d(TAG, "currentPosition = " + currentPosition + " mRightProgressPos = " + mRightProgressPos);
