...
public class RichTextView extends ScrollView {
    ...
    private int rtTextHintColor = Color.parseColor("#757575");
    ...
    public RichTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        rtTextHintColor = ta.getColor(R.styleable.RichTextView_rt_view_text_hint_color, Color.parseColor("#757575"));
    ...
    public TextView createTextView(String hint, int paddingTop) {
        ...
        textView.setHintTextColor(rtTextHintColor);
        return textView;
    }
...
//        }
        XRichText.getInstance().loadImage(imagePath, imageView, rtImageHeight, root, false);
