...
//        Emoji.fromChars("\u0023\u20e3"),
    ...
    public static void addEmojis(Context context, Spannable text, int emojiSize, int emojiAlignment, int textSize, int index, int length, boolean useSystemDefault) {
        ...
        EmojiIconSpan[] oldSpans = text.getSpans(0, textLength, EmojiIconSpan.class);
        ...
        for (int i = index; i < textLengthToProcess; i += skip) {
            ...
            if (icon > 0) {
                text.setSpan(new EmojiIconSpan(context, icon, emojiSize, emojiAlignment, textSize), i, i + skip, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
        }
    }
