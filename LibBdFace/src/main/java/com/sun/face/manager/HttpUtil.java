...
import com.sun.face.model.RequestParams;
import com.sun.face.parser.AccessTokenParser;
import com.sun.face.parser.Parser;
import com.sun.face.util.Base64RequestBody;
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call,@NonNull Response response) throws IOException {
                ...
                try {
                    ...
                    handler.post(() -> listener.onError(faceError));
                }
