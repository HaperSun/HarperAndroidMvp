...
import com.sun.face.util.DeviceUuidFactory;
...
public class APIService {
     ...
     * @param sk
     */
    public void initAccessTokenWithAkSk(final OnResultListener<AccessToken> listener, Context context,
                                        String ak, String sk) {
    ...
    public void record(OnResultListener listener, String userId, String enterId, String base64Img) {
        RegParams params = new RegParams();
        params.setBase64Img(base64Img);
        params.setUserId(userId);
        params.setGroupId(enterId);
        RegResultParser parser = new RegResultParser();
        HttpUtil.getInstance().post(RECORD_URL, params, parser, listener);
    }


    public void compare(OnResultListener listener, String userId, String enterId, String base64Img) {
        RegParams params = new RegParams();
        params.setBase64Img(base64Img);
        params.setUserId(userId);
        params.setGroupId(enterId);
        RegResultParser parser = new RegResultParser();
        HttpUtil.getInstance().post(COMPARE_URL, params, parser, listener);
    }
