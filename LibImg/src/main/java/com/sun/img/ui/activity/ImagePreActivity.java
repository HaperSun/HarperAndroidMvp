...
import com.sun.img.databinding.ActivityImagePreBinding;
import com.sun.img.manager.ConfigManager;
import com.sun.img.provider.ImagePickerProvider;
import com.sun.img.ui.adapter.ImagePreViewAdapter;
 ...
 * @note: 相册选择——图片预览
 */
public class ImagePreActivity extends BaseMvpActivity<ActivityImagePreBinding> implements View.OnClickListener {
