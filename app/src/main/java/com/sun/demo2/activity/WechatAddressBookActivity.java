...
import com.sun.demo2.databinding.ActivityWechatAddressBookBinding;
 ...
 * @note: 仿通讯录
 */
public class WechatAddressBookActivity extends BaseMvpActivity {

    private Context mContext;
    private ActivityWechatAddressBookBinding bind;

    public static void start(Context context) {
        Intent intent = new Intent(context, WechatAddressBookActivity.class);
        context.startActivity(intent);
    }

    @Override
    public int layoutId() {
        return R.layout.activity_wechat_address_book;
    }

    @Override
    public void initView() {
        mContext = this;
        bind = (ActivityWechatAddressBookBinding) mViewDataBinding;
    }
