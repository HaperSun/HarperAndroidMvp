...
import com.sun.demo2.databinding.ActivityDetectLoginBinding;
...
import com.sun.face.util.ImageUtil;
 ...
 * @note: 识别后登陆
 */
public class DetectLoginActivity extends BaseMvpActivity {
    ...
    private ActivityDetectLoginBinding bind;

    public static void start(Context context) {
        Intent intent = new Intent(context, DetectLoginActivity.class);
    ...
    public void initView() {
        bind = (ActivityDetectLoginBinding) mViewDataBinding;
        ...
        bind.successImage.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (bind.successImage.getTag() == null) {
                    ...
                    int w = (int) getResources().getDimension(R.dimen.dp50);
    ...
    private void initWaveview(Rect rect) {
        ...
        mWaveview.setWaveColor(Color.parseColor("#28FFFFFF"), Color.parseColor("#3cFFFFFF"));
                ...
                APIService.getInstance().identify(new OnResultListener<RegResult>() {
                    ...
                    public void onResult(RegResult result) {
                        ...
                        if (maxScore > 80) {
                            ...
                            ToastHelper.showCustomToast("登陆成功");
                            finish();
                            return;
                        } else {
