...
import com.sun.video.anim.FeedAnim;
import com.sun.video.i.FeedDetailListClickListener;
import com.sun.video.i.FeedDetailViewCallBack;
import com.sun.video.model.VideoModel;
import com.sun.video.ui.adapter.FeedDetailAdapter;
...
public class FeedDetailView extends FrameLayout implements FeedDetailListClickListener {
    ...
    public void showDetailView(FeedView parentView, final VideoModel videoModel, FeedPlayerView playerView, int distanceY) {
        ...
        parentView.addView(this, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        //保存之前的callback
        ...
        //将播放器添加进view
        addView(playerView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, playerViewHeight));
        //启动上移动画
