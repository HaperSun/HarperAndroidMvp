...
import com.sun.video.i.FeedListCallBack;
import com.sun.video.model.FeedPlayerManager;
import com.sun.video.model.VideoModel;
import com.sun.video.ui.adapter.FeedListAdapter;
...
public class FeedListView extends FrameLayout implements FeedListItemView.FeedListItemViewCallBack {
    ...
    public void onStartFullScreenPlay(FeedListItemView feedListItemView, int position) {
        ...
        addView(feedListItemView.getFeedPlayerView(), new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
