...
import com.sun.video.i.ISuperPlayerListener;
import com.sun.video.i.SuperPlayer;
import com.sun.video.model.SuperPlayerDef;
import com.sun.video.model.SuperPlayerGlobalConfig;
import com.sun.video.model.SuperPlayerImpl;
import com.sun.video.model.SuperPlayerModel;
import com.sun.video.model.SuperPlayerObserver;
import com.sun.video.model.VipWatchModel;
import com.sun.video.model.entity.DynamicWaterConfig;
import com.sun.video.model.entity.PlayImageSpriteInfo;
import com.sun.video.model.entity.PlayKeyFrameDescInfo;
import com.sun.video.model.entity.VideoQuality;
import com.sun.video.model.net.LogReport;
import com.sun.video.ui.player.FloatPlayer;
import com.sun.video.ui.player.FullScreenPlayer;
import com.sun.video.ui.player.Player;
import com.sun.video.ui.player.WindowPlayer;
import com.sun.video.util.NetWatcher;
import com.sun.video.util.TUIBuild;
...
import static com.sun.video.model.SuperPlayerModel.PLAY_ACTION_AUTO_PLAY;
import static com.sun.video.model.SuperPlayerModel.PLAY_ACTION_MANUAL_PLAY;
...
public class SuperPlayerView extends RelativeLayout {
        ...
        public void onBackPressed(SuperPlayerDef.PlayerMode playMode) {
            switch (playMode) {
                ...
                case WINDOW:// 当前是窗口模式，返回退出播放器
                    if (mPlayerViewCallback != null) {
                        mPlayerViewCallback.onClickWindowCloseBtn();
                    }
                    break;
    ...
    public void switchPlayMode(SuperPlayerDef.PlayerMode playerMode) {
        if (playerMode == SuperPlayerDef.PlayerMode.WINDOW) {
            ...
            if (mPlayerViewCallback != null) {
                mPlayerViewCallback.onStartFloatPlay();
            }
            if (mControllerCallback != null) {
