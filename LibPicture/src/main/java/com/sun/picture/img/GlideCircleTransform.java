...
import com.sun.picture.util.ImgLoaderUtils;
 ...
 * @author: Harper
 * @date: 2021/12/10
 * @note: 解决Glide使用CircleImageView异常的问题
 */
public class GlideCircleTransform extends BitmapTransformation {
    ...
    public GlideCircleTransform(Context context, float borderWidth, int borderColor) {
        ...
        mBorderWidth = ImgLoaderUtils.dip2px(context, borderWidth);
